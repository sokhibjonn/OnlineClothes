    ...
    productList(fresh)
        ...
        <div style="border: 0px;" class="card h-100">
          ...
          <h5 style="font-size:12px;text-align:center;font-weight:700;color:red" class="card-title">` + elem.category + `</h5>
            ...
            <p style="color:black;text-align:center;font-size:12px;font-weight:800" class="card-text">Rs. `+ elem.price + `</p>
            <svg  id="decrementt-count" onclick="handleeDecrement()" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-suit-heart mma" viewBox="0 0 16 16">
